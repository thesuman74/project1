...
<head>
	...
	<body>
		...
		<!-- <header -->
			...
			<section id="Recent-books" class="bookshelf">
				<div class="container">
					<div class="row">
					...
					<div class="row">
						<div class="inner-content">
							...
							<ul class="tabs">
								...
								<li data-tab-target="#COMPUTER" class="tab">COMPUTER</li>
				...
				<div class="container">
					<div class="row">
						<div class="inner-content">
							...
							<div class="section-header align-center">
								<div class="title">
									<span>View questions samples</span>
								</div>
							...
							<div class="btn-wrap align-center">
								<a href="#" class="btn-outline-accent btn-accent-arrow" tabindex="0">Read All Questions<i class="icon icon-ns-arrow-right"></i></a>
							</div>
